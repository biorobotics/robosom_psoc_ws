...
int main(void)
{
    ...
    for(;;)
    {
        ...
        if(ADC_DelSig_1_IsEndConversion(ADC_DelSig_1_RETURN_STATUS))
        {
            ...
            adc_mv_f32 = ADC_DelSig_1_CountsTo_mVolts(ADC_DelSig_1_GetResult32()/50);
